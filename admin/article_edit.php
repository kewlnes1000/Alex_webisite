              ...
              <form id="article">
                ...
                <div class="form-group">
                  ...
                  <select id="category" class="form-control">
                    ...
                    <option value="科技" <?php echo ($data['category'] == "科技")?'selected':''; ?>>科技</option>
                ...
                <div class="form-group " >
                  ...
                  <input type="hidden" id="image_path" value="<?php echo (!is_null($data['images']))?$data['images']:''; ?>">
                  <div class="show_image">
                    <?php if(!is_null($data['images'])):?>
                      <img style="width:800px" src='<?php echo "../" . $data['images']; ?>'>
                    <?php endif; ?>
                  </div>
        ...
        $("#article").on("submit",function(){
            if ($("#title").val() == '' || $("#content").val() == '') {
              ...
              $.ajax({
  			        ...
  			        url : "../php/update_article.php",  //目標給哪個檔案 同 form 的 action 屬性
