      ...
      <div class="container">
          ...
          <div class="row ">
            ...
            <div class="col-xs-12 col-sm-12" style=" height:60px">
                <a href="article_add.php" class="btn btn-primary btn-lg">新增文章</a>
            </div>
          </div>
          <div class="row">
                  ...
                  <?php if(!empty($datas)): ?>
                    <?php foreach ($datas as $a_data): ?>
                        <tr >
                          ...
                          <td >
                            <a class="btn btn-light" href="article_edit.php?i=<?php echo $a_data['id'];?>">編輯</a>
                            <a class="btn btn-danger del_article" href="javascript:void(0);" data-id="<?php echo $a_data['id'];?>">刪除</a>
                          </td>
                        </tr>
                    <?php endforeach; ?>
                    <?php else: ?>
        ...
        $("a.del_article").on("click",function(){
          ...
          if(c){
            $.ajax({
              ...
              url : "../php/del_article.php",  //目標給哪個檔案 同 form 的 action 屬性
