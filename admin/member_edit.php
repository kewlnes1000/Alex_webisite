  ...
  <body>
      ...
      <div class="container">
          ...
          <div class="row ">
            ...
            <div class="col-xs-12 col-sm-12">
              <form class="from-horizontal" id="register_form">
                <input type="hidden" id="id" value="<?php echo $data['id'];?>">
                <div class="form-group row">
                  <label for="username" class="col-sm-2 col-form-label">會員帳號</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="username" id="username" placeholder="請設定您的帳號" required value="<?php echo $data['username'];?>">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="password" class="form-control" id="password" placeholder="請設定您的密碼" >
                    <div class="invalid-feedback">
                      請再次確認您的密碼
                    </div>
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="name" id="name" placeholder="請設定您的暱稱" required value="<?php echo $data['name'];?>">
                  </div>
                </div>
                <div class="form-group row">
    ...
    $(document).on("ready",function(){
      ...
      $("#register_form").on("submit",function(){
          ...
          $.ajax({
            type : "POST",	//表單傳送的方式 同 form 的 method 屬性
            url : "../php/update_user.php",  //目標給哪個檔案 同 form 的 action 屬性
            data : {	//為要傳過去的資料，使用物件方式呈現，因為變數key值為英文的關係，所以用物件方式送。ex: {name : "輸入的名字", password : "輸入的密碼"}
              id : $("#id").val(),
              u : $("#username").val(),
              pw : $("#password").val(),
